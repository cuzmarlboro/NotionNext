...
const BLOG = {
      ...
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I am a programmer 🐻,Hi，Always believe that good things are about to happen_🎉',
      ...
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Hezeying, 博客', // 网站关键词 英文逗号隔开
      ...
      PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-one-light.css', // 代码块默认主题
      ...
      PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-material-dark.css', // 深色模式主题
